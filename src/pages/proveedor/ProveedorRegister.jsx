      ...
      <section className="m-8 flex">
        ...
        <div className="w-full lg:w-3/4 flex flex-col items-center justify-center">
          <div className="text-center">
            <Typography variant="h2" className="font-bold mb-4">Unete a nosotros como proveedor</Typography>
          ...
          <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
            ...
            <Typography variant="paragraph" className="text-center text-blue-gray-500 font-medium mt-4">
              No estas registrado?
              <Link to="/proveedorLogin" className="text-gray-900 ml-1">Inicia sesion aqui</Link>
            </Typography>
          </form>
